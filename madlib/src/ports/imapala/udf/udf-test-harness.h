...
class UdfTestHarness {
 public:
  ...
  static bool ValidateUdf(boost::function<RET(UdfContext*)> fn,
      const RET& expected) {
  ...
  static bool ValidateUdf(boost::function<RET(UdfContext*, const A1&)> fn,
  ...
  static bool ValidateUdf(
      boost::function<RET(UdfContext*, const A1&, const A2&)> fn,
  ...
  static bool ValidateUdf(
      boost::function<RET(UdfContext*, const A1&, const A2&, const A3&)> fn,
  ...
  static bool ValidateUdf(
      boost::function<RET(UdfContext*, const A1&, const A2&, const A3&,
          const A4&)> fn,
 ...
 private:
  template<typename RET>
  static bool Validate(UdfContext* context, const RET& expected, const RET& actual) {
