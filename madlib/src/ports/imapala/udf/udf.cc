...
UdfContext::UdfContext() : impl_(new UdfContextImpl()) {
}

UdfContext::~UdfContext() {
  impl_->CheckLocationAlloctionsEmpty();
...
UdfContextImpl::UdfContextImpl()
  : debug_(false), version_(UdfContext::v1_2), num_warnings_(0) {
}
...
bool UdfContextImpl::CheckLocationAlloctionsEmpty() {
