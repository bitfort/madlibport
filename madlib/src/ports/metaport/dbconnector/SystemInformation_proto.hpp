...
#ifndef MADLIB_mainmem_SYSTEMINFORMATION_PROTO_HPP
#define MADLIB_mainmem_SYSTEMINFORMATION_PROTO_HPP
...
/**
 * @brief Cached information about mainmemQL types
 *
...
struct TypeInformation {
	...
	/**
	 * For a fixed-size type, typlen is the number of bytes mainmemQL uses to
    ...
    /**
     * typbyval determines whether internal mainmem routines pass a value of
     ...
     * on the mainmemQL garbage collection for cleanup.
     */
    TupleDesc tupdesc;
...
/**
 * @brief Cached information about mainmemQL functions
 *
...
/**
 * @brief Cached information about the mainmemQL system catalog
 *
 * In order to guarantee type-safety through reflection/type-introspection, the
 * C++ AL has to call many mainmemQL functions that are tagged as expensive due
 ...
 * <http://www.mainmemql.org/docs/current/static/plhandler.html>).
 *
 * @note
 ...
 *     cleanup but instead rely on the mainmemQL garbage collector.
 */
struct SystemInformation {
     ...
     * Note: Collation support has been added to mainmemQL with commit
...
#endif // defined(MADLIB_mainmem_SYSTEMINFORMATION_PROTO_HPP)
