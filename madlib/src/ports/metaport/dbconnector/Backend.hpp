...
#ifndef MADLIB_mainmem_BACKEND_ABSTRACTION_HPP
#define MADLIB_mainmem_BACKEND_ABSTRACTION_HPP
...
// with commit e26c539e by Robert Haas <rhaas@mainmemql.org>
...
madlib_InitFunctionCallInfoData(FunctionCallInfoData& fcinfo, FmgrInfo* flinfo,
    ...
    // Collation support has been added to mainmemQL with commit
...
#endif // defined(MADLIB_mainmem_BACKEND_ABSTRACTION_HPP)
