...
#ifndef MADLIB_mainmem_UDF_IMPL_HPP
#define MADLIB_mainmem_UDF_IMPL_HPP
 ...
 *
 * @param fcinfo The mainmemQL FunctionCallInfoData structure
 */
...
#endif // defined(MADLIB_mainmem_UDF_IMPL_HPP)
