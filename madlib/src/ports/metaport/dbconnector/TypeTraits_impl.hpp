...
#ifndef MADLIB_mainmem_TYPETRAITS_IMPL_HPP
#define MADLIB_mainmem_TYPETRAITS_IMPL_HPP
...
struct TypeTraits<TransparentHandle<T, IsMutable> > {
...
// defined by victor
template <class T>
struct TypeTraits<TransparentHandle<T> > {
  enum { isMutable = TransparentHandle<T>::isMutable };
  enum { alignment = ALIGNOF_DOUBLE };
  enum { typeClass = dbal::ArrayType };
...
#endif // defined(MADLIB_mainmem_TYPETRAITS_IMPL_HPP)
