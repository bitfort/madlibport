...
#ifndef MADLIB_mainmem_TRANSPARENTHANDLE_PROTO_HPP
#define MADLIB_mainmem_TRANSPARENTHANDLE_PROTO_HPP
...
#endif // defined(MADLIB_mainmem_TRANSPARENTHANDLE_PROTO_HPP)
