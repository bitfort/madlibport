...
#ifndef MADLIB_mainmem_NATIVERANDOMNUMBERGENERATOR_IMPL_HPP
#define MADLIB_mainmem_NATIVERANDOMNUMBERGENERATOR_IMPL_HPP
...
#endif // defined(MADLIB_mainmem_NATIVERANDOMNUMBERGENERATOR_IMPL_HPP)
