...
#ifndef MADLIB_mainmem_FUNCTIONHANDLE_PROTO_HPP
#define MADLIB_mainmem_FUNCTIONHANDLE_PROTO_HPP
...
protected:
     ...
     * AnyType is to enforce a "lazy" conversion to mainmemQL Datums. This is
