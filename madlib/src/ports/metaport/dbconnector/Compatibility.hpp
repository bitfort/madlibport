...
#ifndef MADLIB_mainmem_COMPATIBILITY_HPP
#define MADLIB_mainmem_COMPATIBILITY_HPP
...
namespace mainmem {
namespace {
// No need to make these function accessible outside of the mainmem namespace.
...
/**
 * The following has existed in mainmemSQL since commit ID
 ...
 * http://developer.mainmemql.org/pgdocs/postgres/xaggr.html
 *
 * This function is essentially a copy of AggCheckCallContext from
 * backend/executor/nodeAgg.c, which is part of mainmemQL >= 9.0.
 */
inline
int
AggCheckCallContext(FunctionCallInfo fcinfo, MemoryContext *aggcontext) {
    ...
    /* More recent versions of mainmemQL also have a window aggregate context.
...
#endif // defined(MADLIB_mainmem_COMPATIBILITY_HPP)
