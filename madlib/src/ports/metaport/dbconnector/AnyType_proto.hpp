...
#ifndef MADLIB_mainmem_ANYTYPE_PROTO_HPP
#define MADLIB_mainmem_ANYTYPE_PROTO_HPP
...
/**
 * @brief Proxy for mainmemQL objects
 *
 ...
 * - Null
 * - A scalar value, which is just a mainmemQL Datum
 * - A function composite value, which is a virtual composite value consisting
 *   of all function arguments
 * - A native composite value, which is a mainmemQL HeapTupleHeader
...
public:
    ...
    bool isNull() const;
    bool isComposite() const { return mContentType == ReturnComposite; }
...
#endif // defined(MADLIB_mainmem_ANYTYPE_PROTO_HPP)
