 ...
 * map them to ultimately use the mainmemQL memory routines to protect against
 * memory leaks.
...
/**
 * @brief operator new for mainmemQL. Throw on fail.
 *
...
/**
 * @brief operator delete for mainmemQL. Never throws.
 *
...
/**
 * @brief operator new for mainmemQL. Never throws.
 *
