...
#ifndef MADLIB_mainmem_TRANSPARENTHANDLE_IMPL_HPP
#define MADLIB_mainmem_TRANSPARENTHANDLE_IMPL_HPP
...
#endif // defined(MADLIB_mainmem_TRANSPARENTHANDLE_IMPL_HPP)
