...
#ifndef MADLIB_mainmem_SYSTEMINFORMATION_IMPL_HPP
#define MADLIB_mainmem_SYSTEMINFORMATION_IMPL_HPP
...
/**
 * @brief Get (and cache) information from the mainmemQL catalog
 *
...
/**
 * @brief Get (and cache) information about a mainmemQL type
 *
...
/**
 * @brief Get (and cache) information about a mainmemQL function
 *
...
TypeInformation::getTupleDesc(int32_t inTypeMod) {
    if (tupdesc != NULL)
        ...
        // It is an anonymous type, but mainmemQL has it in its own cache
...
#endif // defined(MADLIB_mainmem_SYSTEMINFORMATION_IMPL_HPP)
